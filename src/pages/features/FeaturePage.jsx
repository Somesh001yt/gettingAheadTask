    ...
    <div className="feature-container">
      <div className="input-container">
        <div className="input-btn relative">
          ...
          <div className="absolute right-20  md:right-16 lg:right-32 top-2 text-[20px]">
            <ion-icon name="image-outline"></ion-icon>
          </div>
          <div className="absolute right-12 md:right-8 lg:right-20 top-2 text-[20px] -rotate-45 ">
